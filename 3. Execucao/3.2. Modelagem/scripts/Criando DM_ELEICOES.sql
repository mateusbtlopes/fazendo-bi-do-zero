USE [DM_ELEICOES]
GO
/****** Object:  Table [dbo].[DIM_CANDIDATO]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DIM_DATA]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DIM_ELEICAO]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DIM_HORA]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DIM_PARTIDOS]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FATO_APURACAO_ELEICOES]    Script Date: 12/11/2016 14:38:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[FATO_APURACAO_ELEICOES]  WITH NOCHECK ADD  CONSTRAINT [FK_FATO_APURACAO_ELEICOES_DIM_CANDIDATO] FOREIGN KEY([DIM_CANDIDATO_SKEY_DIM_CANDIDATO])
